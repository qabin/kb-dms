...
public class PPAesUtils {
    ...
    private static final String KB_SECURITY_AES_KEY = "Aa123456789";
    ...
    public static String encodeAES(String input) {
        return doAES(input, KB_SECURITY_AES_KEY, Cipher.ENCRYPT_MODE);
    }
    ...
    public static String decodeAES(String input) {
        return doAES(input, KB_SECURITY_AES_KEY, Cipher.DECRYPT_MODE);
    }
