...
CREATE TABLE `us_sql_editor_tab`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(1024),
...
CREATE TABLE `us_favorite_table`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    `datasource_id` INT(11) NOT NULL,
...
CREATE TABLE `us_favorite_group`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `us_favorite_datasource`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    `datasource_id` INT(11) NOT NULL,
    `account` VARCHAR(1024) NOT NULL,
    `create_time` DATETIME NOT NULL,
...
CREATE TABLE `us_active_sql_editor_tab`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `st_sql_syntax_error_count_timeline`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `st_sql_syntax_error_count_day`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `st_sql_exe_result_count_timeline`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `st_sql_exe_result_count_day`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    `type` INT(11) NOT NULL COMMENT '1. 全部 2. 执行成功 3. 执行失败 4. 执行中',
    `count` INT(11) NOT NULL,
    `create_time` DATETIME NOT NULL,
...
CREATE TABLE `st_sql_exe_biz_total`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cf_datasource_permission_sql_options`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    `datasource_id` INT(11) NOT NULL,
...
CREATE TABLE `cf_datasource_permission_member`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    `datasource_id` INT(11) NOT NULL,
    `account` VARCHAR(256) NOT NULL,
...
CREATE TABLE `cf_datasource_owners`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    `datasource_id` INT(11) NOT NULL,
    `name` VARCHAR(256) NOT NULL,
    `account` VARCHAR(256) NOT NULL,
...
CREATE TABLE `cf_bus_group_users`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cf_bus_group_owners`(
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(256) NOT NULL,
    `account` VARCHAR(256) NOT NULL,
    `bus_group_id` INT(11) NOT NULL,
